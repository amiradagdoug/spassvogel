...
mongoose.connect('mongodb://127.0.0.1:27017/Restaurant-api', { useNewUrlParser: true, useUnifiedTopology: true }).then(() => {
    console.log('Verbindung  to MongoDB');
})
    .catch((err) => {
        console.error('Failed to connect to MongoDB', err);
    });

const restaurant2 = new mongoose.Schema({
    name: String,
    adresse: String,
    kategorie: String
});
// Restaurant-Modell erstellen
const Restaurant = mongoose.model('Restaurant', restaurant2);
...
{ name: "amira", adresse: "252651", kategorie: "burgerrestaurant" }];
